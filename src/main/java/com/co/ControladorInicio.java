...
public class ControladorInicio {
    ...
    public String editar(@PathVariable("username") String username, Model model){
         // Este método toma como parámetros una variable "username" extraída de la ruta 
         //y un objeto "model" para pasar datos a la vista
        ...
        // Se agrega el oyente encontrado al objeto "model" para pasarlo a la vista
